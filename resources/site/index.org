...
* Tools{{[:sup " " [:a {:style "font-size: 14px;" :href "#"} "↑"]]}}
  ...
  | [[./images/clojure-logo.png]] | [[https://github.com/alexander-yakushev/compliment][Compliment]] |   0.1.3 | [[https://github.com/alexander-yakushev/compliment/wiki/][Wiki]]            | Clojure completion library optimized for working on Android.                                                   |
  | [[./images/emacs.png]]        | [[https://github.com/clojure-emacs/ac-cider][ac-cider]]   |   0.1.1 |                 | Compliment front-end for GNU/Emacs. Interacts with REPL via [[https://github.com/clojure-emacs/cider][CIDER]] (formerly nrepl.el).                         |
  | [[./images/nightcode.png]]    | [[https://nightcode.info/][Nightcode]]  |  0.3.11 |                 | A simple IDE for Clojure and Java projects targeting the command line, the desktop, the web, Android, and iOS. |
