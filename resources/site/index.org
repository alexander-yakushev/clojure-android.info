...
* Tools{{[:sup " " [:a {:style "font-size: 14px;" :href "#"} "↑"]]}}
  ...
  | [[./images/nightcode.png]] | [[https://nightcode.info/][Nightcode]]  |                  | A simple IDE for Clojure and Java projects targeting the command line, the desktop, the web, Android, and iOS. |
...
* Applications{{[:sup " "[:a {:style "font-size: 14px;" :href "#"} "↑"]]}}
  ...
  | [[./images/nightweb.png]]   | [[https://nightweb.net][Nightweb]] ([[https://github.com/oakes/Nightweb][source]])   | [[https://github.com/oakes][Zach Oakes]]    | Nightweb connects your Android device to an anonymous, peer-to-peer social network. |
