...
* How good is Skummet?{{[:sup " " [:a {:style "font-size: 14px;" :href "#"} "↑"]]}}
  ...
  compared to vanilla Clojure. Benchmarking application was a simple hello-world
  ...
  |---------------------------+---------+---------+---------------|
  | Load time (seconds)       |    1.28 |    0.62 |          51.6 |
  | Uberjar size (KB)         |    3640 |    2533 |          30.4 |
  | Heap usage (after GC, KB) |    3749 |    2614 |          30.3 |
  ...
  | Parameter                                | Clojure | Skummet | Reduction (%) |
  |------------------------------------------+---------+---------+---------------|
  | Load time (first launch, seconds)        |    2.02 |    0.82 |          59.4 |
  | "Hot" load time (next launches, seconds) |    1.90 |    0.64 |          66.3 |
  | APK size (KB)                            |    1920 |     956 |          50.2 |
  | Heap usage (after GC, KB)                |    5469 |    3408 |          37.7 |
